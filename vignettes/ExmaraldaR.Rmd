...
It can be useful to merge files. E.g. if you distribute snippets to students. merge\_exb\_file() coalesces several files. This does the same as Transcription \> Merge transcriptions just with multiple files at a time. Therefore you provide a list of file e.g. via rChoiceDialogs::rchoose.files()
